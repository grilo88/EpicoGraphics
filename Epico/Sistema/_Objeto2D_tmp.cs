...
namespace Epico.Sistema2D
{
    ...
    /// </summary>
    //public abstract class Objeto2D : Objeto2Dim, ICloneable
    //{
        ...
        //        {
        //            totalX += ((Eixos2)Vertice[i]).X;
        //            totalY += ((Eixos2)Vertice[i]).Y;
        //        }

        //        return new Vetor2(this, totalX / (float)Vertice.Count(), totalY / (float)Vertice.Count());
        //    }
        //}
        ...
        //    for (int i = 0; i < Vertice.Count(); i++)
        //    {
        //        p1 = new Vetor2(this, ((Eixos2)Vertice[i]).X, ((Eixos2)Vertice[i]).Y);
        //        if (i + 1 >= Vertice.Count())
        //        {
        //            p2 = new Vetor2(this, ((Eixos2)Vertice[0]).X, ((Eixos2)Vertice[0]).Y);
        //        }
        //        else
        //        {
        //            p2 = new Vetor2(this, ((Eixos2)Vertice[i + 1]).X, ((Eixos2)Vertice[i + 1]).Y);
        //        }
        //        Aresta.Add(p2 - p1);
        //    }
        //}
        ...
        //    float raioMax = ((Vertice2)Vertice[idx]).Raio;
        ...
        //    for (int i = 0; i < Vertice.Count(); i++)
        //    {
        //        ((Vertice2)Vertice[i]).Raio += ((Vertice2)Vertice[i]).Raio * percentual / 100;
        ...
        //    for (int i = 0; i < Vertice.Count(); i++)
        //    {
        //        if (((Vertice2)Vertice[i]).Raio > v)
        //        {
        //            v = ((Vertice2)Vertice[i]).Raio;
        //            idxMax = i;
        //        }
        //    }
        //    return idxMax;
        ...
        //{
        //    XMax = Vertice.Max(x => ((Eixos2)x).X);
        //    XMin = Vertice.Min(x => ((Eixos2)x).X);
        //    YMax = Vertice.Max(x => ((Eixos2)x).Y);
        //    YMin = Vertice.Min(x => ((Eixos2)x).Y);
        //}
        ...
        //    for (int i = 0; i < Vertice.Count(); i++)
        //    {
        //        Eixos2 eixo = Util2D.RotacionarPonto2D((Eixos2)Origem[0], (Eixos2)Vertice[i], graus);
        //        ((Eixos2)Vertice[i]).X = eixo.X;
        //        ((Eixos2)Vertice[i]).Y = eixo.Y;
        //    }
        ...
        //        {
        //            Eixos2 eixo = Util2D.RotacionarPonto2D(Centro, (Eixos2)Aresta[i], graus);
        //            ((Eixos2)Aresta[i]).X = eixo.X;
        //            ((Eixos2)Aresta[i]).Y = eixo.Y;
        //        }
        //    }
        ...
        //    ((Objeto2D)clone).Vertice = Vertice
